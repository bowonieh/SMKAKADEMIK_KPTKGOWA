...
import 'package:kptkfrontendluring/widgets/app_drawer.dart';
...
Future<int> fetchTotalSiswa() async {
  final dynamic apiUrl =
      Uri.parse(constantsApi.baseUrl + constantsApi.countSiswa);
...
Future<List<JenkelData>> fetchJenkelData() async {
  final dynamic apiUrl =
      Uri.parse(constantsApi.baseUrl + constantsApi.countSiswaByJenkel);
  final prefs = await SharedPreferences.getInstance();
  var token = prefs.getString('tokenJwt') ?? '';
  try {
    final response = await http.get(apiUrl, headers: {
...
Future<List<KotaData>> fetchKota() async {
  final dynamic apiUrl =
      Uri.parse(constantsApi.baseUrl + constantsApi.countSiswaByKota);
  final prefs = await SharedPreferences.getInstance();
  var token = prefs.getString('tokenJwt') ?? '';
  try {
    final response = await http.get(apiUrl, headers: {
...
void fetchProfile(void Function(List<ProfileData>) onSuccess,
  ...
  final dynamic apiUrl =
      Uri.parse(constantsApi.baseUrl + constantsApi.accountInfo);
  final prefs = await SharedPreferences.getInstance();
  var token = prefs.getString('tokenJwt') ?? '';
...
Future<List<TahunData>> fetchTahunKel() async {
  final dynamic apiUrl =
      Uri.parse(constantsApi.baseUrl + constantsApi.countSiswaByYear);
  final prefs = await SharedPreferences.getInstance();
  var token = prefs.getString('tokenJwt') ?? '';
  try {
    final response = await http.get(apiUrl, headers: {
